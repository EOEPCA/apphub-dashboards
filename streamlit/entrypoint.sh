...
jhsingle-native-proxy --destport $destport --authtype none streamlit run /workspaces/dashboard/dashboard.py {--}server.port ${destport} {--}server.headless True {--}server.enableCORS False --port $port